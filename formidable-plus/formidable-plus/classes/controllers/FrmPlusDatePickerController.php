...
class FrmPlusDatePickerController {
    ...
    public function __construct() {
        add_action('frmplus_register_types', [$this, 'register_type']);
    }
    
    public function register_type() {
        FrmPlusFieldsHelper::register_type([
            'type' => 'datepicker',
            'has_options' => true,
            'options_callback' => [$this, 'options_callback'],
        ...
        <div id="<?php echo $id; ?>">
            ...
            <script>
                jQuery(document).ready(function($) {
                    $('.custom-select-rr').select2();
                });
            </script>
            <div class="datepicker-option template" style="display:none">
                <select class="custom-select-rr" name="frmplus_options[option][]">
